...
namespace DoAn
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            dataGridView1.Rows.Add("mh1", "laptop 1", "samsung", lhs[0], null, null);
            dataGridView1.Rows.Add("mh2", "apple watch", "apple", lhs[1], null, null);
            dataGridView1.Rows.Add("mh3", "note 10", "samsung", lhs[0], null, null);
            dataGridView1.Rows.Add("mh4", "dell inspiration", "dell", lhs[2], null, null);
